...
public class ChatBottomView extends LinearLayout{
	...
	public Button getImageGroup() {
		return imageGroup;
	}

	public Button getCameraGroup() {
		return cameraGroup;
	}
	...
	private void findView(){
		...
		imageGroup = (Button) baseView.findViewById(R.id.image_bottom_group);
		cameraGroup = (Button) baseView.findViewById(R.id.camera_group);
